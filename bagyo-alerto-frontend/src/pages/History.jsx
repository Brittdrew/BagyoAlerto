...
export default function History() {
    ...
    const handleExportCSV = () => {
        ...
        const headers = ["#", "Barangay", "City", "Date", "Severity", "PAGASA Signal", "Wind (km/h)", "Rainfall (mm/hr)", "Pressure (hPa)", "Evacuation Center"]
...
const styles = {
    ...
    tableHead: { display: "grid", gridTemplateColumns: "36px 1.6fr 110px 80px 80px 80px 130px 72px", padding: "8px 16px", background: "#f8f9fb", borderBottom: "0.5px solid #e8ecf0", alignItems: "center" },
    th: { fontSize: 10, fontWeight: 600, color: "#bbb", textTransform: "uppercase", letterSpacing: "0.06em" },
    tableRow: { display: "grid", gridTemplateColumns: "36px 1.6fr 110px 80px 80px 80px 130px 72px", padding: "10px 16px", alignItems: "center", transition: "background 0.1s" },
